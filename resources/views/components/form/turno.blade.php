<div class="main">
    <div class="container-form">
        <h3 class="title-form">{{ isset($turno) ? 'Editar' : 'Crear' }} turno</h3>
...
<form x-data="iosCalendar()" x-init="init({{ $fechas ?? '[]' }})" id="multiStepForm"
    @submit.prevent="updateSelectedDatesInput(); $el.submit()" method="POST" action="{{ $ruta }}">
    @csrf
    @isset($method)
        @method($method)
    @endisset
            ...
            <div class="form-step" data-step="2">
                <div class="form-grid">
                    ...
                    <div class="box-style">
                        ...
                        <div class="item-style">
                            <div class="item">
                                <input type="checkbox" name="horario1" id="horario1" value="{{ $horario1 }}">
                                <label for="horario1">Asignar turnos sin horarios</label>
                            </div>
                            <div class="item">
                                <input type="checkbox" name="horario2" id="horario2" value="{{ $horario2 }}">
