<x-body.body>
    ...
    <form x-data="iosCalendar()" x-init="init({{ $fechas ?? '[]' }})" id="multiStepForm"
        @submit.prevent="updateSelectedDatesInput(); $el.submit()" method="POST" action="{{ route('turnos.store') }}">
        @csrf
                ...
                <div class="form-step" data-step="2">
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input type="time" name="hora_inicio" id="hora_inicio" value="{{ old('inicio') }}" required
                                class="form-control">
                        </div>
                        ...
                        <div class="box-style">
                            ...
                            <div class="item-style">
                                <div class="item">
                                    <input type="checkbox" name="horario1" id="horario1" value="{{ old('horario1') }}">
                                    <label for="horario1">Asignar turnos sin horarios</label>
                                </div>
                                <div class="item">
                                    <input type="checkbox" name="horario2" id="horario2" value="{{ old('horario2') }}">
                ...
                <div class="form-step" data-step="3">
                    ...
                    <div class="form-navigation">
                        ...
                        <button type="submit" class="submit-btn">Crear Turno <i class="bi bi-check-circle"></i></button>
                    </div>
                </div>
            </form>
        </div>
